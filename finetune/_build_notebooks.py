...
generator = notebook([
    md(
        ...
        "Run All. Always use a **clean Run All** (Restart & Clear Cell Outputs, or",
        "a fresh *Save Version*) — the GPU pinning below applies only before CUDA",
        "initialises, so re-running single cells in an already-used kernel silently",
        "skips it.",
        "",
        "### Before you run",
