...
def load_model_cell(model_repo: str, max_seq: int) -> dict:
    return code(
        ...
        "# GPU (~7-8 GiB) and cause a misleading OOM at train time even though 7B",
        "# fits fresh. A clean Restart & Run All avoids this; this guard makes a",
        "# reused kernel non-fatal by freeing those globals first.",
...
generator = notebook([
    md(
        ...
        "> 7B fits fresh. The load cell now frees leftovers as a guard, but a real",
